...
urlpatterns = [
    ...
    url(r'^mapa/', include('apps.categoria_mapa.urls', namespace='mapa')),
    ...
    url(r'^subcategoria_producto/', include('apps.ventas.subcategoria_producto.urls', namespace='subcategoria_producto')),
